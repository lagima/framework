				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="active treeview">
							...
							<ul class="treeview-menu">
								<li class="active"><a href="/admin/controllers"><i class="fa fa-circle-o"></i> Controllers</a></li>
								<li class=""><a href="/admin/controllers"><i class="fa fa-circle-o"></i> Models</a></li>
								<li><a href="/admin/templates"><i class="fa fa-circle-o"></i> Templates</a></li>
								<li><a href="/admin/views"><i class="fa fa-circle-o"></i> Views</a></li>
								<li><a href="/admin/routes"><i class="fa fa-circle-o"></i> Routes</a></li>
							</ul>
						</li>
